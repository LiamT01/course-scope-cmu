...
{#if data.user}
    <div class="space-y-8">
        ...
        <div class="space-y-4">
            ...
            <p class="text-sm">This action is irreversible. All data associated with your account will be deleted.</p>
            <div class="space-y-4 sm:max-w-72">
                <CriticalButton on:click={() => openDeleteConfirmationModal = true} class="w-full" size="sm">
                    Delete account
                </CriticalButton>
            </div>
        </div>
