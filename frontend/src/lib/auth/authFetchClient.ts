...
const convertFormToJSON = (form: HTMLFormElement): { [key: string]: FormDataEntryValue } => {
...
export const submitSignUpFormWithinPage = async (e: Event): Promise<FormSubmitResponse> => {
	...
	if (response.ok) {
		openLogInModal.set(false);
		addSuccessToast(
			'Your account has been created. Please check your Andrew email for account activation.'
		);
		form.reset();
	}
...
export const submitPasswordResetRequestLoggedInWithinPage = async (
	e: Event,
	token: string | null,
	expiry: string | null
): Promise<boolean> => {
...
export const submitActivationLinkRequestLoggedInWithinPage = async (
	e: Event,
	token: string | null,
	expiry: string | null
): Promise<boolean> => {
...
export const submitPasswordResetRequestFormWithinPage = async (
	e: Event
...
export const submitPasswordResetFormWithinPage = async (
	e: Event,
	token: string | null
): Promise<FormSubmitResponse> => {
	e.preventDefault();
...
export const submitUsernameChangeFormWithinPage = async (
	e: Event,
	token: string | null,
	expiry: string | null
): Promise<FormSubmitResponse> => {
...
export const submitRatingWithinPage = async (
	e: Event,
	rating: RatingIn,
	token: string | null,
	expiry: string | null
	...
	if (response.ok) {
		addSuccessToast(
			rating.rating_id ? 'Your rating has been updated.' : 'Your rating has been submitted.'
		);
		await invalidateAll();
	}
...
export const deleteRatingWithinPage = async (
	e: Event,
	ratingID: number,
	token: string | null,
	expiry: string | null
...
export const deleteAccountLoggedInWithinPage = async (
	e: Event,
	token: string | null,
	expiry: string | null
): Promise<boolean> => {
